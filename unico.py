...
if __name__ == '__main__':
    ...
    acesso_inicial = True
    lista_pastas = os.listdir(f'U:\\Tributario\\Jose Abdes\\2149\\NFS Matriz\\2023')
    
   
    for path in os.listdir(f'U:\\Tributario\\Jose Abdes\\2149\\NFS Matriz\\2023'):
       
        full_path = f'X:\\Tributario\\Jose Abdes\\2149\\NFS Matriz\\2023' + os.sep + path
